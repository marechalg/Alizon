    ...
    <div class="container">
        <form method="post" class="form-vendeur">
            ...
            <div class="form-group">
                <input type="text" name="nom_contact" placeholder="Nom de contact" value="<?= $nom_contact ?>" required>
                <input type="text" name="email" placeholder="Adresse E-Mail" value="<?= $email ?>" required>
                <input type="text" name="nom_utilisateur" placeholder="Nom d'utilisateur" value="<?= $nom_utilisateur ?>" required>
            </div>

            <div class="form-group">
                <input type="text" name="prenom_contact" placeholder="Prénom de contact" value="<?= $prenom_contact ?>" required>
                <input type="text" name="num_tel" placeholder="Numéro de téléphone" value="<?= $num_tel ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="num_siren" placeholder="Numéro SIREN" value="<?= $num_siren ?>" required>
                
                <input type="password" name="confimer_mdp" id="confimer_mdp" placeholder="Confirmer le mot de passe" required>
            </div>

            <div class="form-group">
                <input type="text" name="adresse_entreprise" placeholder="Adresse de l'entreprise" value="<?= $adresse_entreprise ?>" required>
                <input type="text" name="raison_sociale" placeholder="Raison sociale" value="<?= $raison_sociale ?>" required>
            </div>
