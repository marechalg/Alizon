"use strict";
Array.from(
  document.querySelectorAll("main.acceuilBackoffice button.bilan")
).forEach((btn) => {
  btn.addEventListener("click", () => {
    if (!btn.classList.contains("here")) {
      document
        .querySelector("main.acceuilBackoffice button.bilan.here")
        ?.classList.remove("here");
      btn.classList.add("here");
    }
  });
});
Array.from(document.getElementsByClassName("aside-btn")).forEach(
  (asideButton) => {
    asideButton.addEventListener("click", () => {
      const category =
        asideButton.children[0].children[1].innerHTML.toLowerCase();
...
// TYPES & INTERFACES
// ============================================================================
define("frontoffice/paiement-types", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
...
// ============================================================================
define("frontoffice/paiement-validation", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
...
// AUTOCOMPLETE
// ============================================================================
define("frontoffice/paiement-autocomplete", [
  "require",
  "exports",
  "frontoffice/paiement-validation",
], function (require, exports, paiement_validation_1) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  function setupAutocomplete(params) {
    ...
    if (codePostalInput) {
      codePostalInput.addEventListener("input", (e) => {
        ...
        if (v.trim().length === 0) {
          const box =
            codePostalInput.parentElement.querySelector(".suggestions");
...
// ============================================================================
define("frontoffice/paiement-popup", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
...
// MAIN PAIEMENT LOGIC
// ============================================================================
define("frontoffice/paiement-main", [
  "require",
  "exports",
  "frontoffice/paiement-validation",
  "frontoffice/paiement-autocomplete",
  "frontoffice/paiement-popup",
], function (
  require,
  exports,
  paiement_validation_2,
  paiement_autocomplete_1,
  paiement_popup_1
) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
